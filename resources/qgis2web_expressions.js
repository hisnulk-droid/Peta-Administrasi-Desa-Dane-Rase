...
function exp_JARINGANJALAN_7rule0_eval_expression(context) {
    // highway  IN ('trunk', 'primary', 'secondary')

    var feature = context.feature;
    
    if (feature.properties) {
        return "'trunk', 'primary', 'secondary'".indexOf(feature.get('highway') ) > -1 ;
    } else {
        return "'trunk', 'primary', 'secondary'".indexOf(feature.get('highway') ) > -1 ;
    }
}
...
function exp_JARINGANJALAN_7rule1_eval_expression(context) {
    // highway  IN ('tertiary', 'residential', 'unclassified', 'service')

    var feature = context.feature;
    
    if (feature.properties) {
        return "'tertiary', 'residential', 'unclassified', 'service'".indexOf(feature.get('highway') ) > -1 ;
    } else {
        return "'tertiary', 'residential', 'unclassified', 'service'".indexOf(feature.get('highway') ) > -1 ;
    }
}